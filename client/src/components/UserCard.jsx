...
const UserCard = ({ user }) => {
    ...
    return (
        <div className='p-4 pt-6 flex flex-col justify-between w-full sm:w-72 shadow border border-gray-200 rounded-md bg-white'>
            ...
            <div className='flex mt-4 gap-2'>
                <button onClick={handleFollow} disabled={currentUser?.following?.includes(user._id)} className='w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed'>
